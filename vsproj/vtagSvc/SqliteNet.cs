...
namespace vtagSvc
{
    public class SqliteNet
    {
        ...
        public class File
        {
            ...
            [Indexed]
            public string Hash { get; set; } = "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"; // SHA256 for empty contents
        ...
        [SqliteTable]
        public class Tag // directory
        {
            public const char SEPARATOR = '/';

            // TODO: FileId - Name 을 composite primary key 로 https://github.com/praeclarum/sqlite-net/issues/280
            //[PrimaryKey, AutoIncrement]
            //public long Id { get; set; }
